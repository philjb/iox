...
use data_types::{
    ChunkId, ChunkOrder, CompactionLevel, DeletePredicate, ObjectStorePathPartitionId,
    SequenceNumber, TableSummary,
};
...
impl QuerierParquetChunkMeta {
    ...
    /// Partition ID.
    pub fn partition_id(&self) -> ObjectStorePathPartitionId {
        self.partition_id
    }
